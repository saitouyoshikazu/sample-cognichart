...
<section class="card w-100">
    ...
    <article class="card-body">
        <form action="javascript:void(0);" method="post" id="chartRollbackForm">
            {{ csrf_field() }}
            ...
            <div class="form-group text-center">
                <button type="submit" class="btn btn-danger" onclick="var ok = confirm('You are about to rollback {{ $chartEntity->label() }}.\nAre you sure?'); if (ok) $('#chartRollbackForm').attr('action', '{{ route('chart/rollback') }}');">
